...
export function Summary() {
  ...
  const handleSubmitShipping = async (e) => {
    ...
    const body = {
      ...
      customer_name: `${formData.get("name")} ${formData.get("lastname")}`,
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between max-w-2xl mx-auto">
            ...
            <div className="flex flex-col items-center flex-1">
              <div
                className={`rounded-full p-2 mb-2 bg-muted text-muted-foreground`}
              >
                <MapPin className="h-4 w-4 sm:h-5 sm:w-5" />
              </div>
              <span
                className={`text-xs sm:text-sm font-medium text-center text-muted-foreground`}
              >
                Envío
              </span>
            </div>
          ...
          <div>
            <Card className="sticky top-4">
              ...
              <CardFooter className="flex flex-col">
                <Button
                  type="submit"
                  className="flex gap-3 items-center bg-sky-500 mb-5"
                >
                  <CreditCard />
                  Proceder al pago
                </Button>
